...
class UMLTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        lamb = UMLParameter(scale="lin",
                            ...
                            std=0.1,
                            n=11)
        self.tested = UMLTestCase.GenericUML(max_stimuli=30.0,
                                             min_stimuli=-30.0,
                                             value=30.0,
                                             method='mean',
                                             alpha=alpha,
...
class LogitUMLTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.tested = LogitUML(max_stimuli=30.0,
                               min_stimuli=-30.0,
                               value=30.0,
                               method='mean',
                               alpha=alpha,
...
class WeibullUMLTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        lamb = UMLParameter(scale="lin",
                            ...
                            std=0.1,
                            n=11)
        self.tested = WeibullUML(max_stimuli=1e5,
                                 min_stimuli=1e-5,
                                 value=1e5,
                                 method='mean',
                                 alpha=alpha,
...
class GaussianUMLTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        lamb = UMLParameter(scale="lin",
                            ...
                            std=0.1,
                            n=5)
        self.tested = GaussianUML(max_stimuli=30.0,
                                  min_stimuli=-30.0,
                                  value=25.0,
                                  method='mean',
                                  alpha=alpha,
